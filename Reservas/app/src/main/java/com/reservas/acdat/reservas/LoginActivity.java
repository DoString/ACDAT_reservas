...
import com.reservas.acdat.reservas.actividades.AdminActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>{
    ...
    private void attemptLogin() throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        */
        ...
        digest.update(mPasswordView.getText().toString().getBytes("UTF-8"));
        byte[] sha = digest.digest();
        String pass = "";
        for (int i = 0; i < sha.length; i++) {
            pass += String.format("%02x",sha[i]);
        }
        ...
        /*if (aSwitch.isChecked())
            ...
            params.put("nivel", 0);*/
        reservas.getClient().post(Reservas.URL_LOGIN, params, new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                showProgress(false);
                Toast.makeText(LoginActivity.this, String.valueOf(errorResponse), Toast.LENGTH_SHORT).show();
            }
                ...
                if (result != null) {
                    if (!result.getCode()) {
                        ...
                        if (result.getUsuario() != null)
                            reservas.setUsuario(result.getUsuario());

                        Intent i = null;
                        if (reservas.getUsuario().getNivel() < 1) {
